...
step "1/6  inline JS parses (both live web apps)"
...
step "2/6  PT cannot activate on a production host"
run node scripts/web-checks/pt-production-gate.js

step "3/6  web no-show port vs the LIVE requester helper"
run node scripts/web-checks/noshow-parity.js

step "4/6  Request/Connect/prototype parity harness"
