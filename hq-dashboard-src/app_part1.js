...
const NAV=[
 ...
 {grp:'Platforms',items:[
   {id:'p-request',name:'Request (mobile)',icon:'phone'},
...
const TITLES={
 ...
 'p-request':['Platforms','Gopher Request','The consumer mobile app — where requests are born.'],
 'p-go':['Platforms','Gopher Go','The gopher app — your supply side.'],
